  ...
  return (
    <Card className="relative bg-slate-900 border-slate-700 w-[320px]">
      <CardHeader className="pb-3">
        ...
        <p className="text-xs text-slate-500">액션 블록</p>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {type === "cex" && (
          <div className="space-y-2">
            <label className="text-xs text-slate-400">거래소</label>
        ...
        {type === "dex" && (
          <div className="space-y-2">
            <label className="text-xs text-slate-400">Web3 함수</label>
            <Input
              type="text"
              value={func}
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400">파라미터</span>
          </div>
